...
from mlflow_sagemaker.exceptions import MlflowSageMakerException
import os
import logging
...
def get_tracking_server_url(tracking_server_arn: str) -> str:
    """Returns the url used by MLFlow SageMaker
    ...
    """
    custom_endpoint = os.environ.get("MLFLOW_SAGEMAKER_CUSTOM_ENDPOINT", "")
    if custom_endpoint:
